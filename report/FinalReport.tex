...
\refinit{driving-style} ``Techniques for Drivers to Conserve Fuel,'' \textit{U.S. Department of Energy}, \url{https://afdc.energy.gov/conserve/behavior_techniques.html}, [Accessed: Mar 25, 2023].

\refinit{fuel-force} \textit{FuelForce Fuel Management Systems}, \url{https://info.gartnerdigitalmarkets.com/multiforce-gdm-lp?channel=capterra}, [Accessed: Mar 25, 2023].

\refinit{triscan} \textit{The Triscan Group}, \url{https://www.thetriscangroup.com}, [Accessed: Mar 25, 2023].

\refinit{fuelly} \textit{Fuelly}, \url{https://www.fuelly.com}, [Accessed: Mar 25, 2023].

\refinit{fuelline} C. Olafson, E. Johston, B. Masciotra, and G. Mo. \textit{FuelLine}, \url{https://fuel-line.fly.dev/}, [Accessed: Mar 25, 2023].

\refinit{myearth} ``MyEarth - Track carbon savings,'' \textit{University of Wisconsin}, \url{https://play.google.com/store/apps/details?id=com.ionicframework.myearthapp496614&hl=en_CA&gl=US}, [Accessed: Mar 25, 2023].

\refinit{capture} ``Carbon Footprint \& CO2 Tracker,'' \textit{The Capture Club}, \url{https://play.google.com/store/apps/dev?id=7417037584465272817&hl=en_CA&gl=US}, [Accessed: Mar 25, 2023].
