...
\textbf{App} &
  ...
  \textbf{Parameters} &
  \textbf{Body} \\ \hline
\multirow{5}{*}{\begin{tabular}[c]{@{}c@{}}\\User \end{tabular}} &
  \multirow{5}{*}{\begin{tabular}[c]{@{}c@{}}\\Base Django user\\ model.\end{tabular}} &
  POST &
  /api/accounts/login &
  - &
...
User Profile &
  ...
  - &
  - \\ \hline
\multirow{3}{*}{\begin{tabular}[c]{@{}c@{}}\\ \\ \\Cars \end{tabular}} &
  \multirow{3}{*}{\begin{tabular}[c]{@{}c@{}}\\ \\ Include the list of cars\\ that the user can select\\ from.\end{tabular}} &
  GET &
  /api/cars/ &
...
\multirow{3}{*}{\begin{tabular}{@{}c@{}}\\ \\ \\ \\ \\ \\ \\ Trips\end{tabular}} &
  \multirow{3}{*}{\begin{tabular}[c]{@{}c@{}}\\ \\ \\ \\ \\\ \\ List of trips that the\\ user has recorded.\end{tabular}} &
  GET &
  /api/trips/ &
 ...
 &
  ...
  /api/trips/ &
  - &
  \begin{tabular}[c]{@{}c@{}}started\_at: Date\\ ended\_at: Date\\ route\_coordinates: \{\\ latitude: number\\ longitude: number\\ speed: number\\ heading: number\\ altitude: number\\ accuracy: number\\ altitude\_accuracy: number\\ \}{[}{]}\\ fuel\_consumption: number\\ average\_speed: number\\ co2\_emissions: number\end{tabular} \\ \hline
\end{tabular}}
\caption{\label{table:backend-architecture}This be a table.}
\end{table}
